...
public class BitcoinJ03GetDataFromWalletExtended {

    public static void main(String[] args) throws IOException, UnreadableWalletException {
        System.out.println("BitcoinJ 03 Daten eines Wallets Extended");
        ...
        String filenameWallet = "bitcoinj02createwalletW.wallet"; // notice: uses the watching wallet version

...
public class RedirectedFrame extends JFrame {
     ...
     */
    public RedirectedFrame(boolean catchErrors, boolean logFile, String fileName, int width,
    ...
    public RedirectedFrame(String title, boolean catchErrors, boolean catchOutput, boolean logFile, String fileName, int width,
                           int height, int closeOperation) {

        this.catchErrors = catchErrors;
        this.catchOutput = catchOutput;
        this.logFile = logFile;
        this.fileName = fileName;
        this.width = width;
        this.height = height;

...
public class BitcoinJ07ViewTransactions {

    public static void main(String[] args) throws IOException, UnreadableWalletException {
        // redirect the console to two windows
        RedirectedFrame outputFrameErrors = new RedirectedFrame("Logfileausgaben Fenster", true, false, true, "BitcoinJ07Transactions_Logfile_" + getActualDateReverse() + ".txt", 700, 600, JFrame.DO_NOTHING_ON_CLOSE);
        RedirectedFrame outputFrameOutput = new RedirectedFrame("Programmausgaben Fenster", false, true, true, "BitcoinJ07Transactions_Output_" + getActualDateReverse() + ".txt", 700, 600, JFrame.DO_NOTHING_ON_CLOSE);
        System.out.println("BitcoinJ 07 Zeige die Transaktionen eines Wallets");
        ...
        kit.awaitRunning();
        System.out.println("**********************************************************************************************************************************************");
        System.out.println("Ausgabe der Transaktionen des Wallets");
